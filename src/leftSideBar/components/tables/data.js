     ...
     <div className="content">
      ...
      {/* <!-- Start Content--> */}
       ...
       <div className="row">
        <div className="col-12">
         <div className="card-box">
          <h4 className="mt-0 header-title">KeyTable example</h4>
          <p className="text-muted font-14 mb-3">
           KeyTable provides Excel like cell navigation on any table. Events (focus, blur, action etc) can be assigned to individual cells, columns, rows or all cells.
                                    </p>

          <table id="key-table" className="table table-bordered dt-responsive nowrap">
           <thead>
            <tr>
             <th>Name</th>
             <th>Position</th>
       ...
       <div className="row">
        <div className="col-12">
         <div className="card-box table-responsive">
          <h4 className="mt-0 header-title">Responsive example</h4>
          <p className="text-muted font-14 mb-3">
           Responsive is an extension for DataTables that resolves that problem by optimising the table's layout for different screen sizes through the dynamic insertion and removal of columns from the table.
                                    </p>

          <table id="responsive-datatable" className="table table-bordered table-bordered dt-responsive nowrap">
           <thead>
            <tr>
             <th>Name</th>
             <th>Position</th>
       ...
       <div className="row">
        <div className="col-12">
         <div className="card-box table-responsive">
          <h4 className="mt-0 header-title">Multi item selection</h4>
          <p className="text-muted font-14 mb-3">
          ...
          <table id="selection-datatable" className="table table-bordered dt-responsive nowrap">
           <thead>
            <tr>
             <th>Name</th>
             <th>Position</th>
