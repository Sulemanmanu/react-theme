  ...
  <div className="navbar-custom">
       <ul className="list-unstyled topnav-menu float-right mb-0">
        ...
        <li className="d-none d-sm-block">
         ...
         <li className="dropdown notification-list">
          <a className="nav-link dropdown-toggle  waves-effect" data-toggle="dropdown" href="#" role="button"
         ...
         <li className="dropdown notification-list">
          <a className="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button"
           aria-haspopup="false" aria-expanded="false">
    ...
    <div className="logo-box">
         ...
         <ul className="list-unstyled topnav-menu topnav-menu-left mb-0">
          ...
          <li>
           <h4 className="page-title-main">Small Sidebar</h4>
          </li>
      ...
      <div className="user-box text-center">
           <img src="assets/images/users/user-1.jpg" alt="user-img" title="Mat Helme"
            ...
            <div className="dropdown">
             <a href="#" className="user-name dropdown-toggle h5 mt-2 mb-1 d-block" data-toggle="dropdown"
        ...
        <div className="row">
                <div className="col-xl-4">
                 <div className="card-box">
                  ...
                  <div className="widget-chart text-center">
                   <div id="morris-donut-example" style={{ height: "245px" }} className="morris-chart" dir="ltr"></div>
                ...
                <div className="col-xl-4">
                 <div className="card-box">
                  ...
                  <div id="morris-bar-example" style={{ height: "280px" }} className="morris-chart" dir="ltr"></div>
                 </div>
                </div>
                ...
                <div className="col-xl-4">
                 <div className="card-box">
                  ...
                  <div id="morris-line-example" style={{ height: "280px" }} className="morris-chart" dir="ltr"></div>
                 </div>
                </div>
            ...
            <div className="slimscroll-menu">
             ...
             <div className="p-3">
              ...
              <div className="custom-control custom-switch mb-5">
               <input type="checkbox" className="custom-control-input theme-choice" id="dark-rtl-mode-switch"
                data-bsStyle="assets/css/bootstrap-dark.min.css" data-appStyle="assets/css/app-dark-rtl.min.css" />
               <label className="custom-control-label" for="dark-rtl-mode-switch">Dark RTL Mode</label>
              </div>

              <a href="https://1.envato.market/k0YEM" className="btn btn-danger btn-block mt-3" target="_blank"><i
               className="mdi mdi-download mr-1"></i> Download Now</a>
             </div>
            </div>
           </div>
