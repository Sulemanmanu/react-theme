...
export default class Boxed extends Component {
 render() {
  return (

   <div className="enlarged" data-layout-size="boxed" data-keep-enlarged="true">
    ...
    <div id="wrapper">
     ...
     <div className="navbar-custom">
      ...
      <ul className="list-unstyled topnav-menu topnav-menu-left mb-0">
       ...
       <li>
        <h4 className="page-title-main">Boxed Layout</h4>
       </li>
